...
// Update search results method to ensure proper category data is passed
getSearchResults = async(req, res) => {
    try {
        // ... existing code ...
        
        // Ensure categories have the correct structure
        if (productList && productList.categories) {
            productList.categories = productList.categories.map(cat => ({
                category_id: cat.category_id,
                category_name: cat.category_name,
                category_img: cat.category_img,
                category_count: cat.category_count || 0
            }));
        }
        
        // ... existing code ...
        
        res.render('pages/site/search', {
